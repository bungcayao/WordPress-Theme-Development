 ...
 * @link https://css-tricks.com/the-wordpress-nav-walker-class-a-guided-var_dump/
 *
 ...
 * @package popin
 */
 class popin_header_navwalker extends Walker_Nav_Menu
 {
	/**
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
	 ...
	 if ( $args->has_children && $depth === 0 ) {
		...
		$atts['data-ga-location'] = 'Main Navbar';
	 }
